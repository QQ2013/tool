...
# 1 "/usr/lib/gcc/i686-redhat-linux/4.4.4/include/stddef.h" 1 3 4
# 323 "/usr/lib/gcc/i686-redhat-linux/4.4.4/include/stddef.h" 3 4
...
void display_attribute(struct stat buf, char * name)
{
 ...
 if (((((buf.st_mode)) & 0170000) == (0120000))) {
  ...
  printf("b");
 } else if (((((buf.st_mode)) & 0170000) == (0010000))) {
  printf("f");
 ...
 if (buf.st_mode & (0400 >> 3)){
  printf("r");
 } else {
  printf("-");
 }
 if (buf.st_mode & (0200 >> 3)){
  printf("w");
 } else {
  printf("-");
 }
 if (buf.st_mode & (0100 >> 3)){
  printf("x");
 } else {
  printf("-");
 }
 ...
 if (buf.st_mode & ((0400 >> 3) >> 3)){
  printf("r");
 } else {
  printf("-");
 }
 if (buf.st_mode & ((0200 >> 3) >> 3)){
  printf("w");
 } else {
  printf("-");
 }
 if (buf.st_mode & ((0100 >> 3) >> 3)){
  printf("x");
 } else {
  printf("-");
 }
...
void display_dir(int flag_param, char *path)
{
        ...
        if(count>256)
                my_err("too many files under this dir",218);
